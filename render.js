 ...
 * Accepts optional preloadedTasks to avoid redundant localStorage reads during render sweeps.
 */
function updateHUD(preloadedTasks) {
  const tasks = preloadedTasks || loadTasks();
 ...
 * Accepts optional preloadedTasks to avoid redundant localStorage reads during render sweeps.
 */
function renderTaskList(preloadedTasks) {
